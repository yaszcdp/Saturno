...
urlpatterns = [
    ...
    path('reactivate-sale/<int:pk>/', views.reactivate_sale, name='ReactivateSale'),
    ...
    path('cancel-purchase/<int:pk>/', views.cancel_purchase, name='CancelPurchase'),
    path('reactivate-purchase/<int:pk>/', views.reactivate_purchase, name='ReactivatePurchase'),
    ...
    path('cancel-payment/<int:pk>/', views.cancel_payment, name='CancelPayment'),
    path('reactivate-payment/<int:pk>/', views.reactivate_payment, name='ReactivatePayment'),
    ...
    path('cancel-creditnote/<int:pk>/', views.cancel_creditnote, name='CancelCreditNote'),
    path('reactivate-creditnote/<int:pk>/', views.reactivate_creditnote, name='ReactivateCreditNote'),
